...
//        var service = new MockableITestServiceDouble(realImpl);
...
//        {
//            MockableITestServiceDouble.SetMock(mock1);
...
//        {
//            MockableITestServiceDouble.SetMock(mock2);
//            Thread.Sleep(100); // Give other thread time to set its mock
...
//    [Fact]
//    public void ScopedMock_ShouldRestorePreviousState()
//    {
//        // Arrange
//        var realImpl = Substitute.For<ITestService>();
//        realImpl.GetValue().Returns("Real Value");
...
//        var originalMock = Substitute.For<ITestService>();
//        originalMock.GetValue().Returns("Original Mock");

//        var scopedMock = Substitute.For<ITestService>();
//        scopedMock.GetValue().Returns("Scoped Mock");

//        // Act & Assert
//        MockableITestServiceDouble.SetMock(originalMock);
//        service.GetValue().Should().Be("Original Mock");

//        using (MockableITestServiceDouble.SetScopedMock(scopedMock))
//        {
//            service.GetValue().Should().Be("Scoped Mock");
//        }

//        // Should restore to original mock
//        service.GetValue().Should().Be("Original Mock");
//    }

//    [Fact]
//    public void ScopedMock_ShouldRestoreToNoMock()
//    {
//        // Arrange
//        var realImpl = Substitute.For<ITestService>();
//        realImpl.GetValue().Returns("Real Value");
...
//        // Should restore to no mock (real implementation)
//        service.GetValue().Should().Be("Real Value");
//    }

//    [Fact]
//    public async Task ScopedMock_WithPartialConfiguration_ShouldWork()
//    {
//        // Arrange
//        var realImpl = Substitute.For<ITestService>();
//        realImpl.GetValue().Returns("Real Value");
...
//        var scopedMock = Substitute.For<ITestService>();
//        scopedMock.GetValue().Returns("Scoped Mock Value");
//        scopedMock.GetCountAsync().Returns(Task.FromResult(42));

//        // Act & Assert
//        service.GetValue().Should().Be("Real Value");

//        using (MockableITestServiceDouble.SetScopedMock(scopedMock, async config => config
//            .MockMethod(x => x.GetValue()))) // Only mock GetValue
//        {
//            service.GetValue().Should().Be("Scoped Mock Value"); // Mocked
//            var result = await service.GetCountAsync(); // Real implementation
...
//    [Fact]
//    public void ScopedMock_NestedScopes_ShouldWorkCorrectly()
//    {
//        // Arrange
//        var realImpl = Substitute.For<ITestService>();
//        realImpl.GetValue().Returns("Real Value");
...
//        var mock1 = Substitute.For<ITestService>();
//        mock1.GetValue().Returns("Mock 1");

//        var mock2 = Substitute.For<ITestService>();
//        mock2.GetValue().Returns("Mock 2");

//        var mock3 = Substitute.For<ITestService>();
//        mock3.GetValue().Returns("Mock 3");

//        // Act & Assert
//        service.GetValue().Should().Be("Real Value");

//        using (MockableITestServiceDouble.SetScopedMock(mock1))
//        {
//            service.GetValue().Should().Be("Mock 1");

//            using (MockableITestServiceDouble.SetScopedMock(mock2))
//            {
//                service.GetValue().Should().Be("Mock 2");

//                using (MockableITestServiceDouble.SetScopedMock(mock3))
//                {
//                    service.GetValue().Should().Be("Mock 3");
//                }

//                service.GetValue().Should().Be("Mock 2"); // Back to mock2
//            }

//            service.GetValue().Should().Be("Mock 1"); // Back to mock1
//        }

//        service.GetValue().Should().Be("Real Value"); // Back to real
//    }
...
//        // Act
//        MockableITestServiceDouble.SetMock(mock, config => config
//            .MockMethod(x => x.GetValue())); // Only mock GetValue
